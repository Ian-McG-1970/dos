...
;in = bl=z (-127+127)/dh=v(-127+127)/dl=h(-127+127) - out = bl=v/dx=h
	mov		bl,[testz]
	mov		dh,[testx]
	mov		dl,[testy]
	call	Perspective8	; in = bl=z/ah=v/dx=h/dh=hsign - out = bl=v/ax=h
	mov		bp,dx
	xor		bh,bh
	call	Plot11
...
Perspective8: ; in = bl=z (-127+127)/dh=v(-127+127)/dl=h(-127+127) - out = bl=v/dx=h
	xor		bh,bh
	mov		al,[persvtab8+bx] 
	add 	dh,127
	MUL		dh

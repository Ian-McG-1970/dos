...
Plot32:
; jmp Plot11
	add		bx,bx 			; start ver *4
	mov		di,[BackBufferTable+bx]	; lookup start ver
	shl		bp,2			; start hor *4
	add		edi,[HorPosTab32+bp]	; add start hor
	mov		ecx,[es:di]
	or		ecx,[FillLeftTab32+bp] 
	mov		[es:di],ecx
	ret
...
; get dword from screen
; and it with left mask
; or it with eax
; mov [es:di],e??0
; add di,4
...
rightmask
; dd 11000000000000000000000000000000b
; dd 11110000000000000000000000000000b
; dd 11111100000000000000000000000000b
; dd 11111111000000000000000000000000b
; dd 11111111110000000000000000000000b
; dd 11111111111100000000000000000000b
; dd 11111111111111000000000000000000b
; dd 11111111111111110000000000000000b
; dd 11111111111111111100000000000000b
; dd 11111111111111111111000000000000b
; dd 11111111111111111111110000000000b
; dd 11111111111111111111111100000000b
; dd 11111111111111111111111111000000b
; dd 11111111111111111111111111110000b
; dd 11111111111111111111111111111100b
; dd 11111111111111111111111111111111b
...
; get screen
; and screen, leftscreentable[x]
; get colour (eax)
; and colour, leftcolourtable[x]
; or screen,colour
; sta screen

; get andtable,x into reg
; get screen into reg
; and screen with andtable,x to create gap

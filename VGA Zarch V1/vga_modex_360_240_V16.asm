...
;
 ...
 pop ax
			...
			sub		cx,di		; subtract start from end
 shr di,2
 inc di
...
FillJumpTable:	dw	Jump000,Jump004,Jump008
...
edgeleft:	db 15-1, 15-(2+1), 15-(4+2+1), 15-(8+4+2+1)
edgeright:	db 1, (2+1), (4+2+1), (8+4+2+1) ; , (4+2+1), (2+1), 1
